# -*- coding: utf-8 -*-
"""
Generate 50 Lessons for N5 across 5 Units (10 lessons per unit).
Each lesson contains EXACTLY 15 well-structured, authentic exercises with 4 options each.
Total exercises: 50 * 15 = 750 exercises.
"""
...
# Master curriculum definition of 50 lessons
# Each entry: (slug, title, description, order, exercises_list)
curriculum = []

# ==============================================================================
# UNIT 1: NHẬP MÔN, BẢNG CHỮ CÁI & CHÀO HỎI (Lessons 0 - 9)
# ==============================================================================
u1_lessons = [
    (
        "n5-lesson-01-vowels",
        "Hiragana 1: Hàng Nguyên Âm (あ・い・う・え・お) & Từ Ghép",
        "5 nguyên âm cốt lõi tạo nên toàn bộ hệ thống phát âm tiếng Nhật kèm các từ vựng ghép đầu tiên.",
        [
    ...
    (
        "n5-lesson-10-self-introduction",
...
curriculum.extend(u1_lessons)

print(f"Loaded Unit 1 ({len(curriculum)} lessons)")
